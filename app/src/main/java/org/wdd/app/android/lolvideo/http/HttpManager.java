...
import org.wdd.app.android.lolvideo.http.impl.VolleyHttpConnecter;
...
public class HttpManager {
    ...
    public HttpSession sendImageRequest(ActivityFragmentAvaliable host, HttpRequestEntry entry, HttpConnectCallback callback) {
        if (connecter == null) {
            Log.e(TAG, "A HttpConnecter getInstance isn\'t setted for HttpManager");
            return null;
        }
        return connecter.sendImageRequest(host, entry, callback);
    }
